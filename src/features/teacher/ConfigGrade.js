            ...
            renderItem={item => (
              <List.Item>
                <List.Item.Meta
                  ...
                  title={
                    <Link
                      onClick = { e => {this.props.setFieldT("CID",item.title)
                        this.props.setFieldT("courseDetail",item.description)
                        this.props.getStudentInSec(item.title
                          ,item.description.academicyear,item.description.term, item.description.section)
                      } }
                      //${item.title}
                      to={this.props.match.url + `/${item.title}`}>
                        {item.title + " - " + item.description.courseName + " Year " +
                        item.description.academicyear + "/" + item.description.term + " Section " +
