  ...
  render(){
    ...
    return (
      <Layout style={{ background: "#fff" }}>
        ...
        >
          <h1>{this.props.CID} - {this.props.courseDetail.courseName}
           Year: {this.props.courseDetail.academicyear}/
           {this.props.courseDetail.term} Section: {this.props.courseDetail.section}</h1>
        </Header>
        <Layout
          style={{
            background: "#fff",
        ...
        >
          <Form>
            ...
            {this.studentInSecListTmp.map(e => (
              <li key={e.TFname}>
                <WrappedDynamicRule
                  ...
                  grade = {e.grade}
                  onChange = {value => {e.grade = value;console.log(e.order);this.studentInSecListTmp[e.order] = e;this.studentInSecListTmpIT++}}
                />
              </li>
            ))}
            ...
            <div style={{ paddingRight: 200, marginTop: 10, textAlign: "center" }}>
              <Button
                onClick = {e => {this.props.setFieldT("studentInSecList",this.studentInSecListTmp)
